...
class CommentServiceIT {
    ...
    /*
    tego rodzaju testy, gdzie wstrzykiwane są komponenty to testy integracyjne, dlatego dobrze je oznaczyć końcówką IT
    ale tez każdy komponent powinien być przetestowany jednostkowo, w oddzieleniu od reszty wartw - zobacz na CommentServiceTest
     */
